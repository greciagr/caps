 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawTable() {
        ...
        data.addColumn('string', 'Fecha del Recibo');
        data.addColumn('number', 'Numero de Recibo');
        data.addColumn('string', 'Servicios');
        data.addColumn('number', 'Sub Total');
        data.addColumn('number', 'Total');

        data.addRows([
          ['061297','Darvin Guzman',true, '11-12-2016', 0001, 'Reconexión', 100, 500],       
        ]);
...
<div class="contact-content">
			 ...
			 <form>
				...
				<select class="combos-cliente" >
                    ...
                    <option value="Primera etapa">Reconexión</option>
                    <option value="Segunda etapa">Recargo</option>
                    <option value="Vista Hermosa">Instalación</option>
                </select><br>
