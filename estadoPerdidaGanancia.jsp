 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawTable() {
        ...
        data.addColumn('number', 'Gran Total');
        data.addColumn('number', 'Ingresos');
        data.addColumn('number', 'Pago Servicios Basicos');
        data.addColumn('number', 'Pagos Otros');
        data.addColumn('number', 'Pago Utileria');
        data.addColumn('number', 'Pago Planillas');
        data.addColumn('number', 'Total Pagos');


        data.addRows([
          [2000,3000,250,250, 500,0,1000]    
        ]);
...
<div class="contact-content">
			 ...
			 <form>
				<input type="text" placeholder="Gran Total" required/>
				<input type="text" placeholder="Ingresos" required/>
                <input type="text" placeholder="Pago Servicios Básicos" required/>
                <input type="text" placeholder="Pagos Otros" required/>
                <input type="text" placeholder="Pago Utileria" required/>
                <input type="text" placeholder="Pagos Planillas" required/>
                <input type="text" placeholder="Total Pagos" required/><br>
