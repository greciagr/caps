 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawTable() {
        ...
        data.addColumn('string', 'permisos');
...
<div class="contact-content">
			 ...
			 <h2>Asignar opciones permisos</h2>
			 </div>
			 <div class="contact-details">				 
			 <form>
				
                 <select class="combos-cliente">
                    <option value="volvo">Selecionar Opciones..</option>
                    <option value="saab">Factura</option>
                    <option value="mercedes">Medicion</option>
                    <option value="mercedes">Cliente</option>
                    <option value="mercedes">Documentos</option>
                    <option value="mercedes">Recibos</option>
                </select>
                 <select class="combos-cliente" >
                    <option value="volvo">Selecionar Permisos...</option>
                    <option value="saab">Leer </option>
                    <option value="mercedes">Modificar</option>
                    <option value="mercedes">Eliminar</option>
                    <option value="mercedes">Buscar</option>
                     <option value="mercedes">Guardar</option>
                </select>
