 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawTable() {
        ...
        data.addColumn('string', 'Medidas');
        data.addColumn('string', 'Unidades de Medidas');
...
<div class="contact-content">
			 ...
			 <h2>Unidades de Meidida</h2>
			 </div>
			 <div class="contact-details">				 
			 <form>
				 <input type="text" placeholder="Medidas" required/>
                 <input type="text" placeholder="Unidades de Medidas" required/>
